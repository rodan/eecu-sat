...
./eecu-sat -i "${sample_dir}//analog_[0-9]*.bin" -t "ch=analog_0.bin:type=o:level=3.00:name=jeff:nth=3:b=1000:a=1000" -o ./out.sr --output-format "srzip:metadata_file=${sample_dir}/metadata_16ch"
ret=$?
